...
class ModeloSedes
{
    ...
    static public function mdlEditarSedes($tabla, $datos)
    {
        ...
        try {
            $sql = "UPDATE $tabla SET nombre_sede =:nombre , direccion =  WHERE id_sede = :id";
    ...
    static public function mdlCambiarEstadoSede($valorId, $estadoId)
    {
        ...
        $stmt->bindParam(":estado", $estadoId, PDO::PARAM_STR);
